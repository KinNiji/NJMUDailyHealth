...
class Core:
    def __init__(self, user_id, password, form_content):
        ...
        driver_path = os.getcwd() + '/bot/plugins/daily_health/lib/'  #
        if sysstr == 'Windows':
        ...
        self.url = {
            ...
            'daily_health': 'http://ehall.njmu.edu.cn/qljfwappnew/sys/lwWiseduHealthInfoDailyClock/index.do'
        }
    ...
    async def web_actions(self):
        ...
        # 登录
        self.driver.get(self.url['daily_health'])
...
class DailyHealth:
    def __init__(self, config_path):
        config = json.loads(decrypt(config_path))
...
if __name__ == '__main__':
    daily_health = DailyHealth('config/19250113.bin')
